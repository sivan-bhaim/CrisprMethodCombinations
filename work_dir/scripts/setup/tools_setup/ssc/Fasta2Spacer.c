 ...
 */
 ...
 /*
  * This is the original Fasta2Spacer.c with minor modifications.
  * These are meant to allow support longer sequences.
  */
...
int ProcessFastaFile(char *input, char *output, int len5Prime, int len3Prime)
{
	...
	while (fgets(tmpLine, (MAX_SEQ_LEN+1), inputFh)!=NULL)
	{
